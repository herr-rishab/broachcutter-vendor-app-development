 ...
 *
 * https://stackoverflow.com/a/47856434/3460025
 */
class StickyFooterItemDecoration : RecyclerView.ItemDecoration() {
    ...
    private fun visibleChildHeightWithFooter(
        ...
        for (i in 0 until onScreenItemCount - 1) {
            ...
            val height = (
                parent.getChildAt(i).height + layoutParams.topMargin +
    ...
    private fun fixLayoutSize(view: View, parent: ViewGroup) {
        ...
        // Finally we measure the sizes with the actual view which does margin and padding changes
        // to the sizes calculated
