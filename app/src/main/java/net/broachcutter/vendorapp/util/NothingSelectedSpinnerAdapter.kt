 ...
 *
 * https://stackoverflow.com/a/12221309/3460025
 *
 * FUCKING SPINNERS MAN
 *
 * Default constructor:
 ...
 * @param context
 */
@Suppress("TooManyFunctions") // can't avoid, need to override
class NothingSelectedSpinnerAdapter(
    ...
    override fun getItemId(position: Int): Long {
        return if (position >= EXTRA) adapter.getItemId(position - EXTRA)
        else
