...
class AnnularCuttersTabAdapter(fragmentManager: FragmentManager, val context: Context) :
    ...
    override fun getItem(position: Int) = when (position) {
        0 -> AnnularCutterSpecificationFragment()
        1 -> AnnularCuttingItemNumberFragment()
        else -> AnnularCutterSpecificationFragment()
    }
